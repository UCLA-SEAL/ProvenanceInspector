...
class Reverter:
    def __init__(self, input_dir, pred_model):
        ...
        self.test_edit_summary = TransformStats(feature_names=["morph", "lemma_", "pos_", "dep_", "static_sentiment"])
        ...
        if osp.exists(osp.join(self.train_dir_pth, 'log.csv')):
            ...
            self.train_edit_summary = TransformStats(feature_names=["morph", "lemma_", "pos_", "dep_", "static_sentiment"])
